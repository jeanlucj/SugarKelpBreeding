...
for (eff in 1:4) cat(names(fitAug@frame)[eff+1], "\t", 1 - pf(aov$'F value'[eff] / aov$'F value'[5], aov$Df[eff], aov$Df[5]), "\n")
for (eff in 1:4) cat(names(fitAug@frame)[eff+1], "\t", 1 - pf(aov$'F value'[eff], aov$Df[eff], 178), "\n")
